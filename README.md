...
## Dataset
The dataset used in this project can be found [here](https://www.kaggle.com/datasets/anuragthantharate/deepslice/data). It contains data relevant to 5G network slicing, including traffic patterns, resource usage, and performance metrics.

## Certificate
A certificate related to this project is available [here](https://drive.google.com/file/d/1akdR633533L_quvFs08CppO4rWxvb-TB/view?usp=sharing).
